...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  # def sign_up_params
  #   params.require(:user).permit(:nickname, :email, :password, :password_confirmation, :first_name, :family_name, :first_name_kana, :family_name_kana, :birth_year, :birth_month, :birth_day)
  # end
